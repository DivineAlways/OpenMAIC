...
export function CanvasToolbar({
  ...
  const calculateSeekIndex = useCallback(
  ...
  const overallPercent =
    scenesCount > 0 ? ((currentSceneIndex + (speechProgress ?? 0)) / scenesCount) * 100 : 0;
        ...
        <Tooltip open={seekHover && onSeek != null && seekPreviewIndex != null}>
          <TooltipTrigger asChild>
            <div
              ...
              style={{
                height: (seekHover || isTouchSeeking) && onSeek ? 8 : 6,
