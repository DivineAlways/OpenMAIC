...
TTS_PRONUNCIATIONS = [
    ...
    (re.compile(r'\bXRPLs\b'), 'X-R-P-L'),
    (re.compile(r'\bXRPL\b'), 'X-R-P-L'),
    ...
    (re.compile(r'\bCEXes\b'), 'C-E-Xes'),
    (re.compile(r'\bCEX\b'), 'C-E-X'),
    (re.compile(r'\bAMMs\b'), 'A-M-Ms'),
    (re.compile(r'\bAMM\b'), 'A-M-M'),
    (re.compile(r'\bMEV\b'), 'M-E-V'),
    (re.compile(r'\bRSI\b'), 'R-S-I'),
    (re.compile(r'\bEVM\b'), 'E-V-M'),
    (re.compile(r'\bUTXO\b'), 'U-T-X-O'),
    (re.compile(r'\bTVL\b'), 'T-V-L'),
    (re.compile(r'\bBIP\b'), 'B-I-P'),
    (re.compile(r'\bODL\b'), 'O-D-L'),
    (re.compile(r'\bRPCA\b'), 'R-P-C-A'),
